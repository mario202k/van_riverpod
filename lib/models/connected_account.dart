class ConnectedAccount {
  ...
  static ConnectedAccount fromMap(Map map) {
    ...
    connectedAccount.externalAccounts = External_accounts.fromMap(map['external_accounts']);
...
class External_accounts {
  ...
  static External_accounts fromMap(Map map) {
    if (map == null) return null;
    External_accounts external_accounts = External_accounts();
    external_accounts.object = map['object'];
    external_accounts.data = map['data'];
    external_accounts.hasMore = map['has_more'];
    external_accounts.url = map['url'];
